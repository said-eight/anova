<template>
 ...
 <div class="container bg-transparent"  id="restaurantes"  >
 <div class="card mb-3 mx-auto bg-transparent border-0 " >
  <div class="row no-gutters">
    <div class="col-md-5">
      <img src="img/home_morra.png" class="card-img mt-4 " alt="..." style="width:450px;" >
    </div>
    <div class="col-md-7 ">
    ...
    <li class="list-group-item border-0 bg-transparent">
      <h5  class="card-title text-right " id="titulog">Perfecto para </h5>
      <h5  class="card-title text-right " id="tituloh"> RESTAURANTES como el tuyo</h5>
      </li>
    <li class="list-group-item border-0 bg-transparent">  
    ...
    <div class="col ">
      <div class="card h-100 bg-transparent border-0 ">
        <div class="card-body mx-auto">
          ...
          <p class="card-text" id="tituloc">BAR</p>        </div>
      </div>
    </div>
    <div class="col ">
      <div class="card h-100 bg-transparent border-0">
    ...
    <div class="col mb-4">
      <div class="card h-100 bg-transparent border-0">
        <div class="card-body">
          ...
          <p class="card-text" id="tituloc">COMIDA RAPIDA</p>       
         </div>
      </div>
    </div>
  </div>
